...
gcloud run deploy $SERVICE_NAME --source=server --region=$REGION --allow-unauthenticated --set-env-vars="GCLOUD_PROJECT=$PROJECT_ID,CLIENT_ORIGIN=https://$PROJECT_ID.web.app"
